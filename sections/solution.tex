...
\begin{table}[H]
	...
	\begin{tabular}{ p{3cm} p{3cm} p{6cm} }
		...
		Parrot Olympe  & \begin{minipage}{.1\textwidth}
			\includegraphics[width=30mm, height=30mm]{parrot.png}
...
Python script \\ \addlinespace
		Parrot Sphinx  & \begin{minipage}{.1\textwidth}
			\includegraphics[width=30mm, height=30mm]{parrot.png}
		...
		Gazebo simulator  & \begin{minipage}{.1\textwidth}
			\includegraphics[width=30mm, height=30mm]{gazbo-logo.png}
		...
		Roboflow  & \begin{minipage}{.1\textwidth}
			\includegraphics[width=30mm, height=30mm]{roboflow.png}
