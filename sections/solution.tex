...
Full diagram view of the solution and communication and connection interfaces used is shown in \Cref{fig:diagram-fig}	
\begin{figure}[tbp]
	\centering
	\includegraphics[width=0.9\textwidth]{diagram.jpeg}
	\caption{Diagram figure for the solution.}
	\label{fig:diagram-fig}
\end{figure}
