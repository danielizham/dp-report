...
\begin{figure}[tbp]
	\centering
	\includegraphics[width=0.8\textwidth]{connection.png}
...
\cref{fig:printed-parts} leaving only the parts shown in
\cref{fig:components} and the weight reduced to
\SI{193}{grams}. 
Now the drone take-off is normal, but the drone faces difficulty moving normally, so we removed all 3D parts, and now the drone moves normally.
...
\begin{figure}[tbp]
	\centering
	\includegraphics[width=0.8\textwidth]{fulldronehardware.png}
...
\begin{figure}[tbp]
	\centering
	\includegraphics[width=0.6\textwidth]{target-distribution}
...
\begin{figure}[tbp]
	\centering
        \includegraphics[width=0.6\textwidth]{fixed-target-distribution}
	\caption{The distribution of the initial positions of the
...
\begin{figure}[tbp]
	\centering
	\includegraphics[width=0.6\textwidth]{mobile-target-distribution}
	\caption{The distribution of the initial positions of the
