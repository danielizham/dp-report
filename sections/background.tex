...
%the main idea was to propose a navigation algorithm that enables each \gls{uav} to determine its own movement locally and track pedestrians (mobile targets), it focused on multiple drones to cover a specific area.
% #2
