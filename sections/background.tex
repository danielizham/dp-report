...
and various techniques that were used to accomplished them. 
...
Reviewing these three areas of focus have helped us learnt
...
% {{{ Part 1
% #1
Related to the first category, \citeauthor{hua20} 
