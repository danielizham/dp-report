...
requested script. After that, the user can press on the Launch/Start Mission 
button which as it name suggests starts the execution. 
...
captures the QR code as shown in the video stream window. 
