...
\begin{figure}[tbp] 
	\centering
	\includegraphics[width=1.0\textwidth, height=7cm]{model-2-output} 
	\caption{Model No. 2 output} \label{fig:model-2-output} 
\end{figure}

\begin{figure}[tbp] 
	\centering
	\includegraphics[width=1.0\textwidth, height=7cm]{model-3-output} 
...
The mistake that was made is that the we used the large \textsc{yolo}v5 on a small dataset
...
\begin{table}[tbp]
	\begin{center}
		...
		\begin{tabular}{c c c c c c} 
			\toprule
			\textbf{Model} & \textbf{\textsc{yolo}v5 version} & \textbf{epochs} & 
			\textbf{Data Augmentation} & \textbf{mAP 0.5:0.95} & \textbf{Performance Rating}\\
			\midrule
